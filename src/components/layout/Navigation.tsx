...
export default function Navigation() {
	const { pathname, dictionary, isMobileMenuOpen, setIsMobileMenuOpen, handleLogoClick, navLinks } =
		useNavigation();
			...
			<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
				<div className='flex justify-between items-center h-20'>
					...
					<div className='flex items-center space-x-1 md:space-x-3'>
						<button className='hidden md:flex w-10 h-10 items-center justify-center text-nordic hover:text-mosque hover:bg-nordic/5 rounded-full transition-colors' title={dictionary.common.search}>
						...
						<div className='px-6 py-6 flex flex-col space-y-1'>
							{navLinks.map((link, i) => (
								<motion.div
									...
									transition={{ delay: 0.05 + i * 0.06, duration: 0.22, ease: 'easeOut' }}
								>
									<Link
